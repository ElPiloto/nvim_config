    ...
    filesystem = {
      components = {
        name = function(config, node, state)
          ...
          local real_output = common.name(config, node, state)
          local text = real_output["text"]
          return {text = text, highlight = real_output["highlight"]}
        end
      },
      filtered_items = {
